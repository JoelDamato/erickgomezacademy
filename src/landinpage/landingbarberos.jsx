...
<nav className="w-full fixed top-0 bg-black bg-opacity-80 backdrop-blur-md z-50">
  <div className="max-w-7xl mx-auto flex justify-between items-center py-4 px-6 md:px-12">
    {/* Logo */}
    <h1 className="text-xl font-bold text-yellow-500">The Barber's Shop</h1>
...
<section
  id="home"
  className="flex flex-col-reverse md:flex-row items-center justify-between w-full h-screen mt-10 px-6"
  style={{
...
<div className="relative mb-12">
  ...
  <div className="absolute left-0 right-0 top-full h-2 bg-yellow-500 mt-2"></div>
</div>
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    {/* Haircuts */}
    <div className="backdrop-blur-sm bg-black/30 p-6 rounded-lg shadow-lg">
      <h3 className="text-4xl text-center font-semibold text-yellow-500 mb-4">Haircuts</h3>
      <div className="relative overflow-hidden rounded-lg">
        ...
        />
        <p className="absolute bottom-2 right-2 bg-yellow-500 text-black px-4 py-1 font-bold text-lg rounded-md shadow-md">
          $30
        </p>
      </div>
    ...
    {/* Beard Grooming */}
    <div className="backdrop-blur-sm bg-black/30 p-6 rounded-lg shadow-lg">
      <h3 className="text-4xl text-center font-semibold text-yellow-500 mb-4">Beard Grooming</h3>
      <div className="relative overflow-hidden rounded-lg">
        <img
...
>
  ...
  <h2 className="text-5xl font-bold text-yellow-500 mb-12"     style={{
      textShadow: "2px 2px 4px rgba(0, 0, 0, 0.7), 4px 4px 6px rgba(0, 0, 0, 0.5)",
      fontFamily: "'Impact', sans-serif",
    }} >Ubicación</h2>
  <div className="flex flex-col md:flex-row items-center justify-center gap-y-8 md:gap-x-10">
    ...
    <div className="backdrop-blur-sm w-full md:w-1/3 flex flex-col items-center bg-black/30 p-6 rounded-lg shadow-lg">
      <img
        src="https://i.pinimg.com/736x/92/d4/65/92d465a3720c007b04524027172131b8.jpg"
        alt="Barbershop"
        className="w-32 h-32 rounded-full shadow-lg mb-4"
      />
      <h3 className="text-3xl font-semibold text-yellow-500 mb-4">Horarios</h3>
