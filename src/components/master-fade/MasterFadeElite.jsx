        ...
        <div className="relative md:h-[80vh]">
          ...
          >
            <div className="relative flex justify-center md:w-24 md:h-24 md:mb-2 mx-auto">
              <img src="/comillas.png" alt="Comillas" className="w-[30%] md:w-[80%] h-auto" />
            </div>

            <div className="mb-4 md:mb-6 w-full mt-4 md:mt-0">
              <img
            ...
            <div className="text-center mb-1 md:mb-6 text-[50%] md:text-base font-['Open_Sans']">
            ...
            <div className="mb-1 md:mb-6 md:w-48 flex justify-end">
              <img src="/firma.png" alt="Firma Erick Gómez" className="w-1/3 md:w-[80%]" />
            </div>

            <div className="w-full mb-1 md:mb-6 text-[20%] md:text-sm font-['Open_Sans']">
              <div className="flex items-start mb-1 md:mb-3 justify-center text-left">
                <img
                  src="/mini-estrella.png"
                  alt="Estrella"
                  className="w-3 md:w-5 h-3 md:h-5 mr-1 md:mr-2 mt-0.5 md:mt-1 flex-shrink-0"
                />
                <p>Fundador de Erick Gómez Academy en 2018, referente N.º 1 en el mundo del Fade a tijera.</p>
              </div>
              <div className="flex items-start mb-1 md:mb-3 justify-center text-left">
                <img
                  src="/mini-estrella.png"
            ...
            <div className="w-1/2 md:mt-4 mx-auto">
              ...
              >
                <img src="/boton-ig.png" alt="Seguir en Instagram" className="flex justify-center md:w-64" />
              </a>
            </div>
          </div>
        </div>
