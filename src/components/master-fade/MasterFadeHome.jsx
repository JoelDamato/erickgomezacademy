  ...
  return (
    <main className="flex flex-col items-center bg-black text-white  overflow-hidden">
      <div className="relative w-full">
        ...
        <div className="relative z-10 w-full bg-azul-profundo py-1 mb-4">
          <h1 className="text-[.7rem] font-bebas uppercase tracking-wide text-center">
        ...
        <div className="relative z-10 flex flex-col items-center px-4 py-0 w-full">
          <div className="text-center mb-4">
            ...
            <p className="text-base font-opensans mb-4 w-[90%] mx-auto">
          ...
          <div className="w-full max-w-md mb-4 relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center ">
              <p className="font-bebas uppercase text-[77%] sm:text-xl tracking-wide">
                QUIERO DOMINAR Y ACELERAR MI TÉCNICA DE FADE
              </p>
              <span className="font-opensans text-xs mt-0">
